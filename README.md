...
public class TelBookApplication {
    ...
    while (true) {
      ...
      switch (operation) {
        ...
        case "search": {
          ...
          //MODIFICATION - STEP 3 - START

          System.out.println("Enter search keyword:");

          String searchKeyword = scanner.nextLine();

          //MODIFICATION - STEP 7 - START
          ...
          //MODIFICATION - STEP 7 - END

          //MODIFICATION - STEP 3 - END
        ...
        case "delete": {
          ...
          if ("id".equalsIgnoreCase(deletionType)) {
            ...
            id = Integer.parseInt(strId); //new tool for students to remember
          ...
          System.out.println("Deleting entry id#=" + id + "...");

          boolean isAnythingDeleted = false;

          if (id != lastEmptyCell) {

            for (int i = id; i < lastEmptyCell && lastEmptyCell < telContacts.length; i++) {
  ...
  private static String[][] searchTelContacts(String[][] telContacts, int lastEmptyCell,
    ...
    if (telContacts.length == 0 || telContacts[0].length == 0) {
      return null;
    }
    ...
    for (int i = 0; i < lastEmptyCell; i++) {
      ...
      for (int j = 0; j < telContacts[i].length; j++) {
        ...
        //MODIFICATION - STEP 8 - START
        if (contains(telContacts[i][j], searchKeyword)) {
        //MODIFICATION - STEP 8 - END
  ...
  //MODIFICATION - STEP 8 - START
  private static boolean contains(String s, String searchKeyword) {

    boolean isFound = false;

    //... Here should go logic to search on string inside another
